...
df_comb = pd.read_csv(r'C:\Users\Kevil\Desktop\Projects\dis_sym_dataset_comb.csv')
df_norm = pd.read_csv(r'C:\Users\Kevil\Desktop\Projects\dis_sym_dataset_norm.csv')
...
logger.info("Encoding symptoms and diseases...")
...
logger.info("Creating feature matrix and target vector...")
...
selector = SelectKBest(chi2, k=min(1000, X.shape[1]))  # Select top 1000 features or all if less
